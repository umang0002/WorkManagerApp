...
import com.example.workersample.MainActivity
import com.example.workersample.R
import com.example.workersample.extension.vectorToBitmap
...
class NotifyWorker(context: Context, params: WorkerParameters) : Worker(context, params) {
    ...
    private fun sendNotification(id: Int) {
        ...
        val bitmap = applicationContext.vectorToBitmap(R.drawable.ic_schedule_white)
        ...
        if (SDK_INT >= O) {
            ...
            val audioAttribute = AudioAttributes.Builder().setUsage(USAGE_NOTIFICATION_RINGTONE)
